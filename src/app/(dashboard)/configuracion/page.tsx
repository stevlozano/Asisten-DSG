...
export default function Page(){
  ...
  return <div className="space-y-6"><div><Typography type="h2">Configuración</Typography><Typography type="body-sm" className="text-muted">Empresa, módulos y cuentas — DSG PERU TECHNOLOGY SAC</Typography></div>
